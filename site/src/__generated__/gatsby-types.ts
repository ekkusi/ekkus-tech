...
declare namespace GatsbyTypes {
  ...
  type SanityProject = SanityDocument &
    Node & {
      readonly _id: Maybe<Scalars["String"]>;
      readonly _type: Maybe<Scalars["String"]>;
      readonly _createdAt: Maybe<Scalars["Date"]>;
  ...
  type SanityGatsbyImagePlaceholder = "dominantColor" | "blurred" | "none";
  ...
  type ProjectsPageQuery = {
    readonly allSanityProject: {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<
          SanityProject,
          "id" | "github_url" | "description" | "name" | "site_url"
        > & {
          readonly image: Maybe<{
            readonly asset: Maybe<Pick<SanityImageAsset, "gatsbyImageData">>;
          }>;
        };
      }>;
    };
